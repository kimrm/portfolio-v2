...
export default function ProjectCard({
  ...
  return (
    <div
      key={_id}
      className="flex rounded-2xl dark:bg-[#080d2b] bg-neutral-100  justify-between flex-col h-full w-full md:w-[350px] lg:w-[460px]"
    >
          ...
          <div className="flex gap-5">
            {website && (
              <Link
                href={website}
                target="_blank"
                className="rounded-xl text-sm py-2 transition-all duration-300 hover:text-zinc-600 dark:hover:text-zinc-300 flex items-center gap-1"
              >
                <svg
